(function (global) {
    global.registerModule('grayscale_and_brightness', function (module) {
        ...
        const setup = (posX, posY) => {
            ...
            grayScaleBrightnessSlider.position(posX + global.SINGLE_FRAME_WIDTH/2 - grayScaleBrightnessSlider.width/2, posY + global.SINGLE_FRAME_HEIGHT - 20);
        }
        ...
        const draw = (posX, posY) => {
            ...
            if (in_img !== null) {
                global.image(global.greyscaleFilter(in_img, grayScaleBrightnessSlider.value()), posX, posY, in_img.width, in_img.height);
            }
        }
